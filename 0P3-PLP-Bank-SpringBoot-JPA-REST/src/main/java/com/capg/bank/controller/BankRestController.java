...
public class BankRestController {
	...
	public String deleteAccount(@PathVariable int id) throws Exception {
		BankBean bs=bsi.deleteAccount(id);
		if(bs==null) {
			throw new Exception("Invalid Id");
	}
		return "yes"+bs.getCustomer_name()+"your Account is deleted Sucessfully";
		
	}
	@GetMapping("/bank/findalltrans")
		
	public List<History> getallTransactions(){
		List<History> bean=bsi.getAllTransactions();
		return bean;
	}
